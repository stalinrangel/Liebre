...
.controller('devolucionesCtrl', function($scope,userService,$http,$mdDialog){
  var req = {
        method: 'GET',
        url: '../api/token4/Laravel/public/api/productos_pedido2',
        headers: {
          ...
          if ($scope.imagenRevision != '') {
            ...
            if ($scope.updateimage) {
              ...
              $http(req).then(function(response){           
                ...
                var bienvenido = {
                       method: 'POST',
                       url: '../api/token4/Laravel/public/api/auth/bienvenido/'+$scope.motorizado.email,
                       headers: {
                         'Authorization' : 'Bearer ' + userService.getCurrentToken()
                       },
                       data: $scope.motorizado
            ...
            function(response){
              if (response.data.user.tipo_usuario==4) {
                 CONFIG.ROL_CURRENT_USER=1;
                  ...
                  var req = {
                     method: 'POST',
                     url: '../api/token4/Laravel/public/api/pedido',
                     headers: {
                       'Authorization' : 'Bearer ' + userService.getCurrentToken()
                     },
                    ...
                    //console.log(response.data);
                   // console.log(response.data.user.name+ ' ' + response.data.user.apellidos);
      ...
      var req = {
        ...
        $http(req).then(function(response){
          ...
          console.log($scope.email.email);
             var req2 = {
                 method: 'POST',
                 url: '../api/token4/Laravel/public/api/auth/resetpassword/'+$scope.email.email,
                 headers: {
                   //'Authorization' : 'Bearer ' + userService.getCurrentToken()
                 },
                 data: $scope.email
  ...
  var OneSignal = window.OneSignal || [];
    ...
    OneSignal.push(function() {
      ...
      OneSignal.getUserId(function(userId) {
        ...
        var req = {
           method: 'PUT',
           url: '../api/token4/Laravel/public/api/update_push/'+CONFIG.ID,
           headers: {
             'Authorization' : 'Bearer ' + userService.getCurrentToken()
           },
           data: $scope.push
...
.controller('trackingCtrl', function($scope,localStorageService,$mdDialog,$window,$cookieStore,$sce,CONFIG,userService,$location,$http,$timeout) {
  ...
  $scope.anularDestino=function(id){
    var req3 = {
        ...
        url: '../api/token4/Laravel/public/api/destino/'+id,
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        },
  ...
  $scope.aceptarPedido=function(id,ev){
    ...
    var acepPedido = {
        method: 'GET',
        url: '../api/token4/Laravel/public/api/encamino/'+localStorageService.get('idLiebre'),
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        }
      }
  ...
  $timeout(function() {
     var req2 = {
        method: 'GET',
        //url: '../api/token4/Laravel/public/api/get_users/'+CONFIG.ID,
        url: '../api/token4/Laravel/public/api/pedidomoto',
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        }
      }
  ...
  if (CONFIG.CLIENTE == '') {
    $timeout(function() {
      var req = {
        method: 'GET',
        //url: '../api/token4/Laravel/public/api/get_users/'+CONFIG.ID,
        url: '../api/token4/Laravel/public/api/get_users/'+100,
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        }
      }
...
.controller('encaminoCtrl', function($scope,$window,$mdDialog,$cookieStore,$sce,CONFIG,userService,$location,$http,$timeout) {
  ...
  $scope.pedidoEntregado=function(tipo,id,ev){
    ...
    var confirm = $mdDialog.confirm()
          ...
          $mdDialog.show(confirm).then(function() {
            ...
            var req3 = {
              method: 'PUT',
              //url: '../api/token4/Laravel/public/api/get_users/'+CONFIG.ID,
              url: '../api/token4/Laravel/public/api/editArticulo/'+id,
              headers: {
                'Authorization' : 'Bearer ' + userService.getCurrentToken()
              },
  ...
  $scope.noRecibioPedido=function(id,cantidad,observacion,pedido_id){
    ...
    var req4 = {
        method: 'PUT',
        //url: '../api/token4/Laravel/public/api/get_users/'+CONFIG.ID,
        url: '../api/token4/Laravel/public/api/pedido/'+pedido_id,
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        },
        data: $scope.motivo
  ...
  $timeout(function() {
     var req2 = {
        method: 'GET',
        //url: '../api/token4/Laravel/public/api/get_users/'+CONFIG.ID,
        url: '../api/token4/Laravel/public/api/pedidomoto2',
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        }
      }
...
.controller('historialCtrl', function($scope,$filter,$cookieStore,$sce,CONFIG,userService,$location,$http,$timeout,$mdDialog) {
  ...
  $timeout(function() {
    var repro = {
      method: 'GET',
      url: '../api/token4/Laravel/public/api/reprogramados/motorizado',
      headers: {
        'Authorization' : 'Bearer ' + userService.getCurrentToken()
      }
    }
    $http(repro).then(function(response){
     ...
     var req2 = {
        method: 'GET',
        //url: '../api/token4/Laravel/public/api/get_users/'+CONFIG.ID,
        url: '../api/token4/Laravel/public/api/pedidomoto3',
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        }
      }
...
.controller('perfilCtrl', function($scope,localStorageService,$cookieStore,$http,$sce,$q,userService,CONFIG,Upload,$mdDialog,$timeout,$location) {
        ...
        var uploadVehiculo = function(idC,data) {
          ...
          file.upload.then(function (response) {
            $timeout(function () {
              ...
              var req = {
                     method: 'PUT',
                     url: '../api/token4/Laravel/public/api/motorizado/'+ CONFIG.ID,
                     headers: {
                       'Authorization' : 'Bearer ' + userService.getCurrentToken()
                     },
                     data: $scope.vehiculo
        ...
        var uploadConductor = function(idC,data) {
          ...
          file.upload.then(function (response) {
            $timeout(function () {
              ...
              var req2 = {
                     method: 'PUT',
                     url: '../api/token4/Laravel/public/api/update_users/'+ CONFIG.ID,
                     headers: {
                       'Authorization' : 'Bearer ' + userService.getCurrentToken()
                     },
                     data: $scope.usuario
  ...
  //if (CONFIG.CLIENTE == '') {
    $timeout(function() {
      ...
      var req = {
        method: 'GET',
        url: '../api/token4/Laravel/public/api/get_users/'+localStorageService.get('idLiebre'),
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        }
      }
 ...
 var req = {
    method: 'PUT',
    url: '../api/token4/Laravel/public/api/update_user',
    headers: {
      'Authorization' : 'Bearer ' + userService.getCurrentToken()
    },
    data: $scope.usuario      
