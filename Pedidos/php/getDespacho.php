 ...
 if (isset($postdata))
  ...
  { 
    ...
    while ($stmt->fetch()) {
      ...
      if ($estado == 2) {
          $outp .= '"estado":"Asignado",';
      } 
      if ($estado == 3) {
          $outp .= '"estado":"Pendiente de Entrega",';
      } 
      if ($id_servicio == 1) {
