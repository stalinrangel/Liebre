...
.controller('sidevar', function ($scope, $log,$mdSidenav,$interval,userService,$http,$filter) {
 ...
 /* $scope.toggleLeft = buildToggler('left');
  ...
  /*var req = {
    method: 'GET',
    url: '../api/token4/Laravel/public/api/admin',
    headers: {
...
.controller('indexCtrl', function($scope,PUSH,$http,userService){
  ...
  $scope.change=function(variables){
    ...
    /*var re = {
        method: 'GET',
        url: '../api/token4/Laravel/public/api/motorizado',
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        }
      }
    ...
    var reqP = {
        method: 'GET',
        url: '../api/token4/Laravel/public/api/posicion',
        headers: {
          //'Authorization' : 'Bearer ' + userService.getCurrentToken()
        }
      }
      ...
      var req = {
        method: 'GET',
        url: '../api/token4/Laravel/public/api/get_pedidos/'+ $scope.banderaPush,
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        }
      }*/
...
.controller('loginCtrl', ['$scope','$location', "CONFIG", '$http', '$sce','$timeout','userService','$mdDialog','$remember' , function ($scope, $location, CONFIG , $http, $sce,$timeout,userService,$mdDialog,$remember) { 
  ...
  setTimeout(function() {
    var reqHora = {
      method: 'GET',
      url: '../api/token4/Laravel/public/api/auth/getHour',
      headers: {
       'Authorization' : 'Bearer ' + userService.getCurrentToken()
      }
    }
...
.controller('PedidosCtrl', function($scope,$timeout,$mdSidenav,$http,userService,$rootScope,$filter,$mdDialog,$window,$cookieStore,CONFIG) {
  ...
  var OneSignal = window.OneSignal || [];
    ...
    OneSignal.push(function() {
      ...
      OneSignal.getUserId(function(userId) {
        ...
        var req = {
           method: 'POST',
           url: '../api/token4/Laravel/public/api/adminpush/store',
           headers: {
             'Authorization' : 'Bearer ' + userService.getCurrentToken()
           },
           data: $scope.push
  ...
  setTimeout(function() {
    var reqcosto = {
      method: 'GET',
      url: '../api/token4/Laravel/public/api/costo',
      headers: {
       'Authorization' : 'Bearer ' + userService.getCurrentToken()
      }
    }
    ...
    function DialogController($scope, $mdDialog, $rootScope) {
      ...
      $scope.select_moto = function(item) {
        ...
        $mdDialog.show(confirm).then(function() {
          ...
          /*var reqE = {
            method: 'PUT',
            url: '../api/token4/Laravel/public/api/update_posicion/' + item.id,
            headers: {
              'Authorization' : 'Bearer ' + userService.getCurrentToken()
            },
            data: $scope.estado2
          ...
          for (var i = 0; i < $scope.pedidos.length; i++) {
            var req = {
              method: 'PUT',
              url: '../api/token4/Laravel/public/api/update_pedidos/' + $scope.pedidos[i].id,
              headers: {
                'Authorization' : 'Bearer ' + userService.getCurrentToken()
              },
              data: $scope.estado
            ...
            $http(req).then(function(response){
              ...
              for (var j = 0; j < destinos_id.length; j++) {
                ...
                var reqD = {
                  method: 'PUT',
                  url: '../api/token4/Laravel/public/api/update_destinos/' + destinos_id[j].id,
                  headers: {
                    'Authorization' : 'Bearer ' + userService.getCurrentToken()
                  },
...
.controller('ListadoProcesoCtrl', function ($scope,$compile, DTOptionsBuilder, DTColumnBuilder, $timeout,$location,$http,$q, $sce, $filter, CONFIG, userService,$mdDialog,$interval,$rootScope, $routeParams) {
  ...
  var req = {
    method: 'GET',
    url: '../api/token4/Laravel/public/api/pedido0',
    headers: {
      'Authorization' : 'Bearer ' + userService.getCurrentToken()
    }
  }
  ...
  setTimeout(function() {
    var reD = {
      method: 'GET',
      url: '../api/token4/Laravel/public/api/distritos',
      headers: {
        'Authorization' : 'Bearer ' + userService.getCurrentToken()
      }
    }
  ...
  function view(pedido) {  
    ...
    var req = {
      method: 'GET',
      url: '../api/token4/Laravel/public/api/get_users/'+pedido.user_id,
      headers: {
        'Authorization' : 'Bearer ' + userService.getCurrentToken()
      }
    }
    ...
    function DialogController($scope, $mdDialog,data) {
      ...
      $scope.select_moto = function(item) {
        ...
        $mdDialog.show(confirm).then(function() {
          var req = {
            method: 'PUT',
            url: '../api/token4/Laravel/public/api/update_pedidos/' + $scope.pedidos.id,
            headers: {
              'Authorization' : 'Bearer ' + userService.getCurrentToken()
            },
            data: $scope.estado
          ...
          for (var i = 0; i < destinos_id.length; i++) {
            var reqD = {
              method: 'PUT',
              url: '../api/token4/Laravel/public/api/update_destinos/' + destinos_id[i].id,
              headers: {
                'Authorization' : 'Bearer ' + userService.getCurrentToken()
              },
              data: $scope.estado_destino
  ...
  function deleteRow(person) {
    ...
    $mdDialog.show(confirm).then(function(result) {
      ...
      var req = {
        method: 'GET',
        url: '../api/token4/Laravel/public/api/devolucion/' + $scope.pedidos.id+'?motivo='+$scope.estado_pedido.motivo,
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        },
  ...
  function rowCallback(tabRow, data, dataIndex) {
    ...
    $('.tabla_pendiente tbody').on('click', '.button_print', function (e) {
      ...
      var req = {
        method: 'GET',
        url: '../api/token4/Laravel/public/api/get_users/'+rowData.user_id,
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        }
      }
      ...
      function DialogController($scope, $mdDialog,data,data2) {
        ...
        $scope.select_moto = function(item) {
          ...
          $mdDialog.show(confirm).then(function() {
            var req = {
              method: 'PUT',
              url: '../api/token4/Laravel/public/api/update_destinos/' + $scope.pedidos.id,
              headers: {
                'Authorization' : 'Bearer ' + userService.getCurrentToken()
              },
              data: $scope.estado
            ...
            var reqP = {
              method: 'PUT',
              url: '../api/token4/Laravel/public/api/update_pedidos/' + $scope.id_pedido,
              headers: {
                'Authorization' : 'Bearer ' + userService.getCurrentToken()
              },
              data: $scope.estado_pedido
    ...
    $('.tabla_pendiente tbody').on('click', '.button_delete', function (e) {
      ...
      $mdDialog.show(confirm).then(function(result) {
        ...
        var req = {
          method: 'PUT',
          url: '../api/token4/Laravel/public/api/update_destinos/' + $scope.destinos2.id,
          headers: {
            'Authorization' : 'Bearer ' + userService.getCurrentToken()
          },
          data: $scope.estado_destino
...
.controller('ListadoenCursoCtrl', function ($scope, $compile, DTOptionsBuilder, DTColumnBuilder, $timeout,$location,$http,$q, $sce, $filter, CONFIG, userService,$mdDialog,$interval,$rootScope) {
  ...
  var req = {
    method: 'GET',
    url: '../api/token4/Laravel/public/api/pedido12',
    headers: {
      'Authorization' : 'Bearer ' + userService.getCurrentToken()
    }
  }
  ...
  function edit(person) {
    ...
    $mdDialog.show(confirm).then(function(result) {
      ...
      var req = {
        method: 'PUT',
        url: '../api/token4/Laravel/public/api/update_pedidos/' + person.id,
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        },
        data: $scope.estado_pedido
      ...
      /*for (var i = 0; i < $scope.id_motorizados.length; i++) {
        var reqE = {
          method: 'PUT',
          url: '../api/token4/Laravel/public/api/update_posicion/' + $scope.id_motorizados[i],
          headers: {
            'Authorization' : 'Bearer ' + userService.getCurrentToken()
          },
     ...
     /* var reqP = {
      ...
      $scope.reprogramar = function() {
        ...
        if ($scope.pedido.reprogramado == 0) {
          ...
          var req = {
            method: 'PUT',
            url: '../api/token4/Laravel/public/api/update_pedidos/' + $scope.pedido.id,
            headers: {
              'Authorization' : 'Bearer ' + userService.getCurrentToken()
            },
          ...
          /*var reqE = {
            method: 'PUT',
            url: '../api/token4/Laravel/public/api/update_posicion/' + $scope.pedido.posicion,
            headers: {
              'Authorization' : 'Bearer ' + userService.getCurrentToken()
            },
            data: $scope.estado_motorizado
          ...
          var reqR = {
            method: 'POST',
            url: '../api/token4/Laravel/public/api/reprogramados/store',
            headers: {
              'Authorization' : 'Bearer ' + userService.getCurrentToken()
            },
    ...
    $('.tabla_encurso tbody').on('click', '.button_moto', function (e) {
      ...
      if ($scope.bandera == 1) {
        ...
        $mdDialog.show(confirm).then(function(result) {
          ...
          var reqP = {
            method: 'PUT',
            url: '../api/token4/Laravel/public/api/update_pedidos/' + rowData.id,
            headers: {
              'Authorization' : 'Bearer ' + userService.getCurrentToken()
            },
            data: $scope.estado_pedido
          ...
          /*var reqE = {
            method: 'PUT',
            url: '../api/token4/Laravel/public/api/update_posicion/' + $scope.id_motorizados,
            headers: {
              'Authorization' : 'Bearer ' + userService.getCurrentToken()
            },
            data: $scope.estado2
    ...
    $(tabRow).on('click', '#select', function () {
        ...
        if (rowData.estado_reprogramado == 0) {
          ...
          $mdDialog.show(confirm).then(function() {
            ...
            var req = {
              method: 'PUT',
              url: '../api/token4/Laravel/public/api/update_pedidos/' + $scope.id_update,
              headers: {
                'Authorization' : 'Bearer ' + userService.getCurrentToken()
              },
            ...
            for (var i = 0; i < $scope.dest_update.length; i++) {
              var req_destinos = {
                method: 'PUT',
                url: '../api/token4/Laravel/public/api/update_destinos/' + $scope.dest_update[i].id,
                headers: {
                  'Authorization' : 'Bearer ' + userService.getCurrentToken()
                },
                data: $scope.estado_destino
...
.controller('ListadoFinalizadosCtrl', function ($scope, $compile, DTOptionsBuilder, DTColumnBuilder, $timeout,$location,$http,$q, $sce, $filter, CONFIG, userService,$mdDialog,$interval,$rootScope) {
  ...
  var req = {
    method: 'GET',
    url: '../api/token4/Laravel/public/api/adminFinalizados',
    headers: {
      'Authorization' : 'Bearer ' + userService.getCurrentToken()
    }
  }
  ...
  function deleteRow(person) {
    ...
    $mdDialog.show(confirm).then(function(result) {
      ...
      var req = {
        method: 'GET',
        url: '../api/token4/Laravel/public/api/devolucion/' + $scope.pedidos.id,
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        },
        data: $scope.estado_pedido
...
.controller('detallePedidoCtrl', function($scope,CONFIG,$sce,$http,$location,$timeout,$filter,userService,$mdDialog,$routeParams) {
  ...
  $scope.actualizar =  function(){
    ...
    if ($scope.cliente.tipo_usuario == 3) {
      ...
      var req_pedido = {
        method: 'PUT',
        url: '../api/token4/Laravel/public/api/update_pedidos/' + $scope.destinos[0].pedido_id,
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        },
      ...
      $http(req_pedido).then(function(response){
        for (var i = 0; i < $scope.destinos.length; i++) {   
          ...
          var req_destinos = {
            method: 'PUT',
            url: '../api/token4/Laravel/public/api/update_destinos/' + $scope.destinos[i].id,
            headers: {
              'Authorization' : 'Bearer ' + userService.getCurrentToken()
            },
    ...
    .then(function(answer) {
      ...
      function DialogController($scope, $mdDialog) {
        ...
        var uploadPic = function(idC) {
          ...
          var req = {
            method: 'POST',
            url: '../api/token4/Laravel/public/api/auth/signup',
            headers: {
              'Authorization' : 'Bearer ' + userService.getCurrentToken()
            },
...
.controller('ListadoClientesCtrl', function ($scope, $compile, $mdDialog, Upload, $rootScope, DTOptionsBuilder, DTColumnBuilder, $timeout,$location,$http,$q, $sce, $filter, CONFIG, userService) {
  ...
  var req = {
    method: 'GET',
    url: '../api/token4/Laravel/public/api/users',
    headers: {
      'Authorization' : 'Bearer ' + userService.getCurrentToken()
    }
  }
  ...
  vm.dtColumns = [
    ...
    function edit(person) {
      ...
      function DialogController($scope, $mdDialog,data,Upload) {
        ...
        var uploadPic = function(idC) {
          ...
          var req = {
            method: 'PUT',
            url: '../api/token4/Laravel/public/api/update_users/'+ $scope.motorizado.id,
            headers: {
              'Authorization' : 'Bearer ' + userService.getCurrentToken()
            },
            data: $scope.motorizado
    ...
    function deleteRow(person) {
      ...
      $mdDialog.show(confirm).then(function() {
        var req = {
          method: 'DELETE',
          url: '../api/token4/Laravel/public/api/destroy_users/'+ person.id,
          headers: {
            'Authorization' : 'Bearer ' + userService.getCurrentToken()
          }
        }
  ...
  $scope.agregar = function() {
    ...
    .then(function(answer) {
      ...
      function DialogController($scope, $mdDialog) {
        ...
        var req = {
          method: 'POST',
          url: '../api/token4/Laravel/public/api/auth/signup_motorizado',
          headers: {
            'Authorization' : 'Bearer ' + userService.getCurrentToken()
          },
          data: $scope.motorizado
        ...
        var uploadPic1 = function(idC) {
          ...
          var reqM = {
            method: 'PUT',
            url: '../api/token4/Laravel/public/api/update_moto_admin/'+ idC,
            headers: {
              'Authorization' : 'Bearer ' + userService.getCurrentToken()
            },
            data: $scope.moto
  ...
  vm.dtColumns = [
    ...
    function edit(person) {
      ...
      function DialogController($scope, $mdDialog,data, Upload) {
        ...
        var uploadPic = function(idC) {
          ...
          var reqM = {
            method: 'PUT',
            url: '../api/token4/Laravel/public/api/update_moto_admin/'+ $scope.motorizado.id,
            headers: {
              'Authorization' : 'Bearer ' + userService.getCurrentToken()
            },
            data: $scope.motorizado
    ...
    function deleteRow(person) {
      ...
      $mdDialog.show(confirm).then(function() {
        ...
        var reqM = {
          method: 'DELETE',
          url: '../api/token4/Laravel/public/api/destroy_moto_admin/'+ person.id,
          headers: {
            'Authorization' : 'Bearer ' + userService.getCurrentToken()
          }
        }
...
/*.controller('ReportesCtrl', function($scope,$timeout,userService,$http,$filter,$location,CONFIG,Excel) {
  ...
  $scope.liquidar = function() { 
    ...
    if (envio) {
      ...
      var req_liquidacion = {
        method: 'POST',
        url: '../api/token4/Laravel/public/api/liquidaciones/store',
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        },
      ...
      $http(req_liquidacion).then(function(response){
        ...
        for (var i = 0; i < $scope.selected.length; i++) {
          ...
          var req_orden = {
            method: 'POST',
            url: '../api/token4/Laravel/public/api/norden/store',
            headers: {
              'Authorization' : 'Bearer ' + userService.getCurrentToken()
            },
            data: $scope.orden[i]
            ...
            if (count == $scope.selected.length) {
              ...
              for (var j = 0; j < $scope.selected.length; j++) {
                if ($scope.selected[j].tipo_usuario == 3) {
                  var req_cancelado = {
                    method: 'PUT',
                    url: '../api/token4/Laravel/public/api/update_pedidos/' + $scope.selected[j].id,
                    headers: {
                      'Authorization' : 'Bearer ' + userService.getCurrentToken()
                    },
                    data: $scope.estado
                ...
                if ($scope.selected[j].tipo_usuario != 3) {
                  var req_cancelado = {
                    method: 'PUT',
                    url: '../api/token4/Laravel/public/api/update_pedidos/' + $scope.selected[j].id_parent,
                    headers: {
                      'Authorization' : 'Bearer ' + userService.getCurrentToken()
                    },
                    data: $scope.estado
...
.controller('ReportesCtrl', function($scope,$timeout,userService,$http,$filter,$location,CONFIG,Excel,$routeParams) {
  ...
  $scope.Consultar = function(){
    ...
    if (consulta) {
      ...
      var req = {
        method: 'GET',
        url: '../api/token4/Laravel/public/api/adminFechas/'+$filter('date')(new Date($scope.cliente.fechaInicio),'dd-MM-yyyy'),
        //url: '../api/token4/Laravel/public/api/admin',
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        }
      ...
      setTimeout(function() {
        var req_liquidados = {
          method: 'GET',
          url: '../api/token4/Laravel/public/api/liquidacionesFechas/'+$filter('date')(new Date($scope.cliente.fechaInicio),'dd-MM-yyyy'),
          headers: {
            'Authorization' : 'Bearer ' + userService.getCurrentToken()
          }
        }
...
.controller('LiquidacionCtrl', function($scope,$timeout,userService,$http,$filter,CONFIG,$location,$mdDialog,Excel) {
  ...
  var req_liqui = {
    method: 'GET',
    url: '../api/token4/Laravel/public/api/liquidaciones/'+ $scope.pedidos[0].user_id,
    headers: {
      'Authorization' : 'Bearer ' + userService.getCurrentToken()
    }
  }
  ...
  function DialogController2($scope, $mdDialog, tipo) {
    ...
    $scope.pagar = function(pago) { 
      ...
      if (pago == 1) {
        ...
        var req_despositado = {
          method: 'PUT',
          url: '../api/token4/Laravel/public/api/liquidaciones/' + $scope.id_liquidacionu,
          headers: {
            'Authorization' : 'Bearer ' + userService.getCurrentToken()
          },
        ...
        $http(req_despositado).then(function(response){
          for (var j = 0; j < $scope.id_ordenu.length; j++) {
            ...
            var req_orden = {
              method: 'PUT',
              url: '../api/token4/Laravel/public/api/norden/'+$scope.id_ordenu[j],
              headers: {
                'Authorization' : 'Bearer ' + userService.getCurrentToken()
              },
              data: $scope.orden[j]
              ...
              if (count2 == $scope.id_ordenu.length) {              
                ...
                for (var k = 0; k < $scope.pendientes.length; k++) {
                  var req_despositado2 = {
                    method: 'PUT',
                    url: '../api/token4/Laravel/public/api/liquidaciones/' + $scope.pendientes[k].id,
                    headers: {
                      'Authorization' : 'Bearer ' + userService.getCurrentToken()
                    },
                    data: estado
...
.controller('ReportesMotoCtrl', function($scope,$timeout,userService,$http,$filter,$location,CONFIG,Excel) {
  ...
  $scope.Consultar = function(){
    ...
    var reqR = {
      method: 'GET',
      url: '../api/token4/Laravel/public/api/reprogramados/'+$scope.fechaIni,
      headers: {
        'Authorization' : 'Bearer ' + userService.getCurrentToken()
      }
    }
...
/*.controller('LiquidacionCtrl', function($scope,$timeout,userService,$http,$filter,CONFIG,$location,$mdDialog,Excel) {
  ...
  $scope.Consultar = function(){
    ...
    var req = {
      method: 'GET',
      url: '../api/token4/Laravel/public/api/liquidaciones/'+ $scope.cliente.id,
      headers: {
        'Authorization' : 'Bearer ' + userService.getCurrentToken()
      }
    }
    ...
    $scope.pagar = function(pago) { 
      ...
      if (pago == 1) {
        for (var i = 0; i < $scope.id_liquidacion.length; i++) {
          ...
          var req_despositado = {
            method: 'PUT',
            url: '../api/token4/Laravel/public/api/liquidaciones/' + $scope.id_liquidacion[i],
            headers: {
              'Authorization' : 'Bearer ' + userService.getCurrentToken()
            },
          ...
          $http(req_despositado).then(function(response){
            ...
            if (count1 == $scope.id_liquidacion.length) {
              for (var j = 0; j < $scope.id_orden.length; j++) {
                ...
                var req_orden = {
                  method: 'PUT',
                  url: '../api/token4/Laravel/public/api/norden/'+$scope.id_orden[j],
                  headers: {
                    'Authorization' : 'Bearer ' + userService.getCurrentToken()
                  },
                  data: $scope.orden[j]
...
.controller('Listado_liquidacionCtrl', function($scope,$timeout,userService,$http,$filter,CONFIG,$mdDialog,Excel) {
  ...
  $scope.pagar = function(item) {
    ...
    var req_despositado = {
      method: 'PUT',
      url: '../api/token4/Laravel/public/api/liquidaciones/' + item.id,
      headers: {
        'Authorization' : 'Bearer ' + userService.getCurrentToken()
      },
      data: $scope.liquidacion_final
...
.controller('Productos_devueltosCtrl', function($scope,$timeout,userService,$http,$filter,$location,CONFIG,Excel) {
  ...
  var req = {
    method: 'GET',
    url: '../api/token4/Laravel/public/api/productos_pedido_fechas',
    headers: {
      'Authorization' : 'Bearer ' + userService.getCurrentToken()
    }
  }
...
.controller('Informacion_devueltosCtrl', function($scope,$timeout,userService,$http,$filter,$location,CONFIG,Excel,$mdDialog) {
  ...
  var req = {
    method: 'GET',
    url: '../api/token4/Laravel/public/api/por_fechas?fecha='+fecha,
    headers: {
      'Authorization' : 'Bearer ' + userService.getCurrentToken()
    }
  }
  ...
  $scope.reponer = function(item) {
    ...
    $timeout(function() {
      var req2 = {
        method: 'PUT',
        url: '../api/token4/Laravel/public/api/agregar_devueltos/'+item.atributo_id,
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        },
        data: $scope.datos
...
.controller('InventarioCtrl', function($scope,$location,$timeout,userService,$http,CONFIG,$mdDialog) {
  var atri = {
    method: 'GET',
    url: '../api/token4/Laravel/public/api/get_ecommerce',
    headers: {
      'Authorization' : 'Bearer ' + userService.getCurrentToken()
    }
  }
  ...
  $scope.onChange = function(pedido) {
    ...
    if (!pedido.almacen1) {
      ...
      $mdDialog.show(confirm1).then(function() {
        ...
        var reqe = {
          method: 'PUT',
          url: '../api/token4/Laravel/public/api/update_users/'+ pedido.id,
          headers: {
            'Authorization' : 'Bearer ' + userService.getCurrentToken()
          },
          data: $scope.datos
...
.controller('ProductosCtrl', function($scope,$location,$timeout,userService,$http,$filter,$mdDialog,CONFIG,Upload) {
  ...
  $timeout(function() {
    var req2 = {
      method: 'GET',
      url: '../api/token4/Laravel/public/api/inventario/'+CONFIG.ECOMMERCE,
      headers: {
        'Authorization' : 'Bearer ' + userService.getCurrentToken()
      }
    }
    ...
    $mdDialog.show(confirm).then(function() {
      for (var i = 0; i < $scope.inventarios.length; i++) {
        if($scope.inventarios[i].id==producto_id){  
          var atri = {
            method: 'DELETE',
            url: '../api/token4/Laravel/public/api/producto/'+producto_id,
            headers: {
              'Authorization' : 'Bearer ' + userService.getCurrentToken()
            }
          }
          ...
          for (var j = 0; j < $scope.inventarios[i].colores.length; j++) {
            if($scope.inventarios[i].colores[j].id==color_id){
              ...
              $timeout(function() {
               var atri = {
                  method: 'DELETE',
                  url: '../api/token4/Laravel/public/api/color/'+color_id,
                  headers: {
                    'Authorization' : 'Bearer ' + userService.getCurrentToken()
                  }
                }
            ...
            for (var k = 0; k < $scope.inventarios[i].colores[j].atributos.length; k++) {
              if($scope.inventarios[i].colores[j].atributos[k].id==idk){
                ...
                $timeout(function() {
                 var atri = {
                    method: 'PUT',
                    url: '../api/token4/Laravel/public/api/atributo/'+id_atributo,
                    headers: {
                      'Authorization' : 'Bearer ' + userService.getCurrentToken()
                    },
                    data:$scope.enviar
  ...
  function DialogController2($scope, $mdDialog, pedido_id, color_id) {
    ...
    $scope.guardarAtributo=function(){
      var atri = {
        method: 'POST',
        url: '../api/token4/Laravel/public/api/atributo/store',
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        },
  ...
  function DialogController($scope, $mdDialog, data) {
    ...
    $scope.guardarColor=function(){
      var atri = {
        method: 'POST',
        url: '../api/token4/Laravel/public/api/color/store',
        headers: {
          'Authorization' : 'Bearer ' + userService.getCurrentToken()
        },
  ...
  function DialogController3($scope, $mdDialog,CONFIG,data) {
    ...
    $scope.addProducto=function(){
      if($scope.addProductos.nombre!='' && $scope.addProductos.descripcion!=''){
        var atri = {
          method: 'POST',
          url: '../api/token4/Laravel/public/api/producto/store',
          headers: {
            'Authorization' : 'Bearer ' + userService.getCurrentToken()
          },
  ...
  function DialogController4($scope, $mdDialog,CONFIG,data) {
    ...
    $scope.edit_Producto=function(){
      if($scope.editProducto.nombre !='' && $scope.editProducto.descripcion!=''){
        var atri = {
          method: 'PUT',
          url: '../api/token4/Laravel/public/api/producto/'+$scope.producto.id,
          headers: {
            'Authorization' : 'Bearer ' + userService.getCurrentToken()
          },
...
.controller('AngularWayChangeDataCtrl', function($scope,$location,$timeout,userService,$http,$filter,$mdDialog,CONFIG,$resource, DTOptionsBuilder, DTColumnDefBuilder) {
  ...
  function addPerson() {
    ...
    var req_add = {
      method: 'POST',
      url: '../api/token4/Laravel/public/api/distritos/store',
      headers: {
        'Authorization' : 'Bearer ' + userService.getCurrentToken()
      },
      data: persons
  ...
  function removePerson(index,person) {
    var req_dlt = {
      method: 'DELETE',
      url: '../api/token4/Laravel/public/api/distritos/'+ person.id,
      headers: {
        'Authorization' : 'Bearer ' + userService.getCurrentToken()
      }
    }
  ...
  $scope.saveContact = function (index) {
    ...
    var req_upd = {
      method: 'PUT',
      url: '../api/token4/Laravel/public/api/distritos/'+ $scope.model.id,
      headers: {
        'Authorization' : 'Bearer ' + userService.getCurrentToken()
      },
      data: distrito
